...
public:
	 ...
	 * @param mode Configuración del grafo (dirigido o no dirigido).
	 * @param vertices Número de nodos en el grafo.
	 */
	 ...
	 * @param node Índice del nodo seleccionado.
	 ...
	 * @param startNode Índice del nodo desde el cual comenzar el recorrido.
	 */
	 ...
	 * @param node Nodo actual en el recorrido DFS.
